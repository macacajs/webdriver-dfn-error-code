...
Object.keys(codes).map(function(name) {
  ...
  errors[name].prototype = Error.prototype;
});

errors['NotImplementedError'] = function(msg) {
  this.name = 'NotImplementedError';
  this.message = msg || 'The method is not implemented yet.';
}

errors['NotImplementedError'].prototype = Error.prototype;

errors['NoContextError'] = function(msg) {
  this.name = 'NoContextError';
  this.message = msg || 'The Context does not exist.';
}

errors['NoContextError'].prototype = Error.prototype;
